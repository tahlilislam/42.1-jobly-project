...
describe("POST /companies", function () {
  ...
  test("ok for admin users to create new companies", async function () {
...
describe("GET /companies", function () {
  ...
  test("throws error: minEmployees greater than maxEmployees", async function () {
    const resp = await request(app).get("/companies").query({ minEmployees: 3, maxEmployees: 2 });
    expect(resp.statusCode).toEqual(400);
    expect(resp.body.error.message).toEqual("minEmployees cannot be greater than maxEmployees");
  });

  test("throws error: invalid filter fields", async function () {
    const resp = await request(app).get("/companies").query({ invalidField: "test" });
    expect(resp.statusCode).toEqual(400);
  });
...
describe("GET /companies/:handle", function () {
  ...
  test("works for a company with job listings", async function () {
...
describe("PATCH /companies/:handle", function () {
  ...
  test("bad request on handle change attempt by admin", async function () {
    const resp = await request(app)
        .patch(`/companies/c1`)
        .send({
          handle: "c1-new",
